...
pub mod dinorunner_api {
    ...
    impl fmt::Display for version_s {
    ...
    unsafe extern "C" {
        ...
        fn dinorunner_isinverted(
            dinorunner: *const dinorunner_s,
            night_mode: *mut c_uchar,
        ) -> c_uchar;
        fn dinorunner_isalive(
            dinorunner: *const dinorunner_s,
            activation_status: *mut c_uchar,
        ) -> c_uchar;
    ...
    impl dinorunner_s {
        pub fn init<T>(
            ...
            unsafe {
                let casted_data = user_data as *mut _ as *mut c_void;
                match dinorunner_init(
                    self as *mut dinorunner_s,
                    dimension as *const dimension_s,
                    casted_data,
                ) {
        ...
        pub fn is_inverted(&self) -> Result<bool, &'static str> {
            unsafe {
                ...
                match dinorunner_isinverted(
                    self as *const dinorunner_s,
                    &mut night_mode as *mut c_uchar,
                ) {
        ...
        pub fn is_alive(&self) -> Result<bool, &'static str> {
            unsafe {
                ...
                match dinorunner_isalive(
                    self as *const dinorunner_s,
                    &mut activation_status as *mut c_uchar,
                ) {
    ...
    #[unsafe(no_mangle)]
    pub extern "C" fn dinorunner_vibrate(duration: c_uint, user_data: *mut c_void) -> c_uchar {
        println!("Vibrating for {duration}");
        return 0;
    }

    #[unsafe(no_mangle)]
    pub extern "C" fn dinorunner_clearcanvas(user_data: *mut c_void) -> c_uchar {
